...
| "各省份，各城市，各乡镇的json文件，和原bootstrap地址控件对应的json格式相同，加入了等级：level，是否是直辖市：isZS，是否是省直属县市：isSZX" | [json](https://github.com/kaisela/Administrative-divisions-of-China/blob/master/dist/json) |
