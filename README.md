...
| 文件列表                                     | 下载地址       |
|:---------------------------------------------|:---------------|
| 省份数据                                        | [provinces.json](https://github.com/kaisela/Administrative-divisions-of-China/blob/master/dist/provinces.json) |
| 城市数据                                        | [cities.json](https://github.com/kaisela/Administrative-divisions-of-China/blob/master/dist/cities.json) |
| 区县数据                                        | [areas.json](https://github.com/kaisela/Administrative-divisions-of-China/blob/master/dist/areas.json) |
| 乡镇（街道）数据                                | [streets.json](https://github.com/kaisela/Administrative-divisions-of-China/blob/master/dist/streets.json) |
| “省份、城市” 二级联动数据                       | [pc.json](https://github.com/kaisela/Administrative-divisions-of-China/blob/master/dist/pc.json) |
| “省份、城市” 二级联动数据（带编码）             | [pc-code.json](https://github.com/kaisela/Administrative-divisions-of-China/blob/master/dist/pc-code.json) |
| “省份、城市、区县” 三级联动数据                 | [pca.json](https://github.com/kaisela/Administrative-divisions-of-China/blob/master/dist/pca.json) |
| “省份、城市、区县” 三级联动数据（带编码）       | [pca-code.json](https://github.com/kaisela/Administrative-divisions-of-China/blob/master/dist/pca-code.json) |
| “省份、城市、区县、乡镇” 四级联动数据           | [pcas.json](https://github.com/kaisela/Administrative-divisions-of-China/blob/master/dist/pcas.json) |
| “省份、城市、区县、乡镇” 四级联动数据（带编码） | [pcas-code.json](https://github.com/kaisela/Administrative-divisions-of-China/blob/master/dist/pcas-code.json) |
| "各省份，各城市，各乡镇的json文件，和原bootstrap地址控件对应的json格式相同，加入了等级：level，是否是直辖市：isZS，是否是省直属县市：isSZX。文件数较多，不一定上传完成，如需完整的课下载程序自行运行一遍即可" | [json](https://github.com/kaisela/Administrative-divisions-of-China/blob/master/dist/json) |
...
[4/5] 正在导出 “乡镇” JSON 数据...
[5/5] 数据抓取完成！
[1/5] 正在导出 “省份、城市” 二级联动数据...
[2/5] 正在导出 “省份、城市、区县” 三级联动数据...
[3/5] 正在导出 “省份、城市、区县、乡镇” 四级联动数据...该步骤操作数据较多，比较耗时，请耐心等候...
[4/5] 正在导出 “各省，各市，各县” json文件数据...该步骤操作数据较多，比较耗时，请耐心等候...
[5/5] 数据更新完成！
```
